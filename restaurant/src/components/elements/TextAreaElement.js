    ...
    <div className="sample-text-area">
      <div className="container box_1170">
        ...
        <p className="sample-text">
          ...
          how do you move from a <del>Strike</del> through of master DVDs with
          the <u>“Underline”</u> marked hand-written title inside a secondhand
          CD case, to a pile of cardboard boxes full of shiny new, retail-ready
